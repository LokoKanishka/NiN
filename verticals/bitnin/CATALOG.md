...
| `bitnin_analyst_tick` | Ejecutar el analista estructurado sobre una ventana de datos. | episodios recuperados, estado de mercado, narrativa reciente | `analysis_output`, referencias a evidencia, logs | `planned` | workflow autoritativo del analista en `bitnin-control` |
