...
| `bitnin_analyst_tick` | Ejecutar el analista estructurado con memoria activa. | episodios, narrativa, memoria activa | `analysis_output` enriquecido | `active` | analyst con memoria activa |
