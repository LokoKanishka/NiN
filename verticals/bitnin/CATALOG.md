...
| `bitnin_hitl_manager` | Analizador de scorecards para priorización humana y gestión de casos. | `batch_report` JSON | `hitl_inbox` Markdown, `hitl_archive` Markdown, `hitl_digest` Markdown | `active` | componente de revisión en `bitnin-hitl` |
